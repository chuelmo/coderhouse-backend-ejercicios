...
app.get('/hello', (req, res) => {
    res.render('hello.pug', {mensaje: 'Hola Mundo de PUG!'})
})
...
app.get('/datos', (req, res) => {
    ...
    let title = req.query.title ? req.query.title : 'Usando plantillas PUG';
    console.log('title ', title, 'max ', max, 'min ', min, 'value ', value)
    res.render('meter.pug', {value: value, min: min, max: max, title: title})
})
