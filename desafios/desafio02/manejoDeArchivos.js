...
const prod1 = {'title': 'Escuadra', 'price': 123.45, 'thumbnail': 'http://localhost:3000'};
const prod2 = {'title': 'Calculadora', 'price': 345.75, 'thumbnail': 'http://localhost:3000'};
const prod3 = {'title': 'Globo Terráqueo', 'price': 459.90, 'thumbnail': 'http://localhost:3000'};

(async function main() {
    try {
        console.log('| Método: deleteAll() | - Comenzamos el ejercicio vaciando el archivo');
        await c.deleteAll();
        let allProducts = await c.getAll();
        console.log('\n| Método: getAll() | - Así está ahora el archivo productos.txt: ', allProducts);
